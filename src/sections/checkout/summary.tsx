...
export default function CheckoutSummary () {
    ...
    return (
        <div className="border border-muted w-full px-3  py-8 min-h-[200px] flex flex-col justify-between rounded-md">
            <h1 className="font-bold text-lg capitalize mb-6">
                detail summary
            </h1>

            <div className="border-t border-muted pt-2 flex flex-col gap-6 items-end mb-5">
            ...
            <div className="border-t border-muted pt-2 flex flex-col gap-3 items-end mb-5">
                <div className="flex items-center justify-between w-full">
